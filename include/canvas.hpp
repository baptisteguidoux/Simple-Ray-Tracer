...
namespace canvas {
  ...
  struct Canvas {
     ...
     *  \brief Set the Color of the point at the given coordinates
     *  \param x_pos x position
     *  \param y_pos y position
     ...
     *  \brief Set the points in the delimited region to the given color
     ...
     *  \brief Export the Canvas as a ppm file
   ...
   *  \brief Add two Canvas, adding each component together
